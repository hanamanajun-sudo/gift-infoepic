...
prods = [
    (1,"어뮤즈 듀 벨벳 틴트","쿠팡 15,800원/올리브영 18,000원","중학생 사이에서 '국민 틴트'. 발색 선명, 지속력 좋음. 용돈으로 사기엔 부담스러워 선물 반응 특히 좋아요.","핑크·코랄 계열 무난","매트 타입이라 건조할 수 있어요"),
    (2,"다꾸 세트(스티커+테이프+펜)","15,000~25,000원","단품보다 세트가 반응 두 배. 아이디어스·지그재그 '중학생 다꾸 세트' 검색 2만 안팎.","다이어리 꾸미기 좋아하는 아이","관심 없으면 '그냥 문구'"),
    (3,"미니 향수 샘플러 세트","20,000~35,000원","풀사이즈는 위험. 조말론·딥티크 미니어처(3~5만)나 국내 샘플(2만)이 딱.","향기에 관심 많은 아이","알코올 향 예민하면 몇 개 못 씀"),
    (4,"무선 블루투스 이어폰","QCY 25,000~35,000 / 버즈FE 79,000원","QCY T13 가성비 최고. 버즈FE는 삼성폰 연동 좋음. 흰색·파스텔 케이스 추천.","학원·통학 길에 음악 듣는 아이","아이폰 유저는 중고 에어팟 추천"),
    (5,"폴라로이드 카메라","인스탁스 미니12 69,000원","13살 여아 '로망'. 필름 1팩(7,000원) 꼭 같이 주세요.","사진 찍고 공유하는 아이","필름값 장당 700~1,000원"),
    (6,"스킨케어 입문 세트","라운드랩 3종 32,000원","폼클렌저+토너+수분크림 기본. 라운드랩·토니모리·이니스프리 추천.","피부 관리 막 시작한 아이","여드름성은 일반 수분라인보다 케어 필요"),
    (7,"산리오 캐릭터 인형","25,000~35,000원","시나모롤·폼폼푸린·쿠로미 인기. 20~30cm 중간 사이즈.","산리오 좋아하는 아이","캐릭터 취향 미리 확인 필수"),
    (8,"무선 충전기 패드","15,000~35,000원","매일 쓰는 실용템. 삼성 15W 듀오(3만)·벨킨 부스트업.","뭘 사줄지 모르겠다면 무난","감동보다 실용성"),
    (9,"손글씨 다이어리 세트","몰스킨미니 22,000+젤펜 8,000=30,000원","아날로그 감성 열풍. 몰스킨·코코로 브랜드 인기.","글쓰기·그림 좋아하는 아이","관심 없으면 '그냥 공책'"),
    (10,"네컷 앨범+스티커 세트","12,000~20,000원","인생네컷 사진 모으는 미니 앨범+꾸미기 스티커. 1.5만원이면 완성.","사진 많이 찍는 아이","서브 선물로 적합"),
]
