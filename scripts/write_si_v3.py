...
# Step 1: Count and delete ALL blocks
all_ids = []
cur = None
while True:
    p = {'page_size': 100}
...
print(f'Deleting {len(all_ids)} blocks...')
for bid in all_ids:
...
# Step 3: Build clean 45 blocks (NO duplication)
...
B.append(bp([("생신: ",True),"어머니, 생신 축하드려요. 평소에 필요하실 것 같아서 준비했어요. 마음에 드시면 좋겠습니다."]))
