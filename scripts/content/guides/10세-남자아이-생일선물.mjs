...
export const slug = '10세-남자아이-생일선물';
...
export const products = [
  {
    ...
    rank: 1,
    pros: '네이버 블로그 5곳 이상에서 반복 언급된 스테디셀러. 조립·전시·놀이 3박자를 갖췄고, F1 좋아하는 아이라면 더 좋아합니다.',
  },
  {
    ...
    rank: 2,
    pros: '블로그 후기에서 "갖고 싶은 선물 1위"로 반복 언급된 카테고리. 활동적인 아이에게 실내외 모두 즐거운 액션 놀이를 선물할 수 있습니다.',
  },
  {
    name: '코리아보드게임즈 할리갈리',
    price: 14870,
    ...
    rank: 3,
    pros: '가족과 함께 즐기기 좋은 정통 보드게임. 1만원대 부담 없는 가격으로 친구 생일선물이나 가벼운 선물용으로도 좋습니다.',
  },
  {
    ...
    rank: 4,
    pros: '초등교사 유튜브 채널에서 실제 추천한 아이템. 저온 타입으로 안전하고, 입체 도안 포함 세트를 고르면 처음 시작하는 아이도 부담이 없습니다.',
  },
  {
    ...
    rank: 5,
    pros: '"초등 3학년 남아 선물 = RC카"라는 전용 블로그 글이 있을 만큼 정석 선물. 야외 활동을 좋아하는 아이에게 딱 맞습니다.',
  },
  {
    ...
    rank: 6,
    pros: '실구매 블로그 후기 "초3 아들이 엄청 좋아했다" 확인됨. 변신로봇 장난감 중 현재 초등 남아 사이에서 레고 다음 인기 시리즈입니다.',
  },
];
